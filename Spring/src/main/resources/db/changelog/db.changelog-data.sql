...
VALUES
    ...
    (10004, 'bborkowski', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Barbara', 'Borkowska', 'F', 'b.borkowska@example.com', '+48765432101', NULL, 'PRIMARY', '+48123456788', 'a.borkowski@example.com', 1, 5, TRUE, TRUE),
    (10005, 'mkowalska', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Maria', 'Kowalska', 'F', 'm.kowalska@example.com', '+48123456790', NULL, 'PRIMARY', '+48987254323', 'm.kowalska2@example.com', 1, 10, FALSE, FALSE),
    (10006, 'pgrzesiak', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Piotr', 'Grzesiak', 'M', 'p.grzesiak@example.com', '+48765432110', NULL, 'HIGH_SCHOOL', NULL, NULL, 2, 7, TRUE, TRUE),
    (10007, 'ekaliszewska', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Ewa Maria', 'Kaliszewska', 'F', 'e.kaliszewska@example.com', '+48876543212', NULL, 'HIGH_SCHOOL', '+48123456891', 'e.wojcik@example.com', 2, 12, FALSE, TRUE),
    (10008, 'snowak', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Sławomir', 'Nowak', 'M', 's.nowak@example.com', '+48123456892', NULL, 'TERTIARY', '+48987654323', 's.nowak@example.com', 3, 20, TRUE, FALSE),
    (10009, 'kwojcik', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Krzysztof', 'Wójcik', 'M', 'k.wojcik@example.com', '+48765432111', NULL, 'TERTIARY', NULL, NULL, 3, 18, TRUE, TRUE),
    (10010, 'mzielinski', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Michał', 'Zieliński', 'M', 'm.zielinski@example.com', '+48123456893', NULL, 'PRIMARY', '+48987654325', 'm.zielinski@example.com', 1, 15, FALSE, FALSE),
    ...
    (1001, 'kzielinska', '$2a$10$o9OcOIN.1bmooaFQJ.1PAOyZxHBA9IXo8qj2dECXrj8Vk9YpvxstO', 'Katarzyna', 'Zielińska', 'F', 'k.zielinska@example.com', '+48678901234', 52.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
INSERT INTO course (course_name, price, max_participants, start_date, is_open_for_registration, tutoring_class_id, is_done, description)
VALUES
    ('Kurs Matematyki dla Początkujących', 499.99, 20, '2025-01-15', TRUE, NULL, FALSE, '<p>Ten kurs jest idealny dla początkujących, którzy chcą poznać podstawy matematyki. Na zajęciach nauczysz się rozwiązywać proste równania, operować na ułamkach oraz radzić sobie z podstawowymi problemami matematycznymi.</p><p>Dzięki praktycznym przykładom i interaktywnym ćwiczeniom zdobędziesz pewność siebie w obliczaniu i rozwiązywaniu zadań. Kurs jest doskonałym wprowadzeniem do dalszej nauki matematyki.</p>'),
    ('Zaawansowany Kurs Języka Angielskiego', 799.00, 15, '2025-02-01', TRUE, NULL, FALSE, '<p>Rozwiń swoje umiejętności językowe dzięki temu zaawansowanemu kursowi języka angielskiego. Program obejmuje zaawansowaną gramatykę, rozbudowane słownictwo oraz praktyczne zastosowanie języka w mowie i piśmie.</p><p>Zajęcia prowadzone są w formie interaktywnych lekcji, które pomogą Ci swobodnie komunikować się w języku angielskim, zarówno w życiu codziennym, jak i zawodowym. Kurs kończy się testem sprawdzającym Twoje postępy.</p>'),
    ('Podstawy Programowania w Pythonie', 599.50, 25, '2025-03-10', TRUE, NULL, FALSE, '<p>Naucz się podstaw programowania w Pythonie, jednym z najpopularniejszych języków programowania na świecie. Kurs obejmuje takie zagadnienia jak zmienne, pętle, warunki, funkcje i obsługa błędów.</p><p>W trakcie zajęć stworzysz pierwsze programy, które będą rozwiązywać rzeczywiste problemy. To idealny wybór dla osób, które chcą rozpocząć swoją przygodę z programowaniem lub poszerzyć swoje umiejętności techniczne.</p>'),
    ('Warsztaty z Fotografii Cyfrowej', 349.99, 10, '2024-01-20', FALSE, NULL, TRUE, '<p>Odkryj tajniki fotografii cyfrowej podczas tych intensywnych warsztatów. Nauczysz się korzystać z ustawień aparatu, takich jak przysłona, czas naświetlania i ISO, aby uzyskać idealne zdjęcia.</p><p>Warsztaty obejmują również podstawy kompozycji oraz wprowadzenie do obróbki zdjęć w popularnych programach graficznych. To świetna okazja, aby rozwinąć swoje umiejętności fotograficzne i tworzyć zachwycające obrazy.</p>'),
    ('Kurs Gotowania dla Początkujących', 299.00, 12, '2025-02-15', TRUE, NULL, FALSE, '<p>Praktyczny kurs dla miłośników gotowania, którzy chcą nauczyć się przygotowywać pyszne i zdrowe potrawy. Program obejmuje podstawowe techniki kucharskie, takie jak krojenie, smażenie, pieczenie i gotowanie na parze.</p><p>Podczas kursu przygotujesz różnorodne dania, które z łatwością odtworzysz w domu. Zajęcia prowadzone są w małych grupach, co zapewnia indywidualne podejście i przyjazną atmosferę.</p>'),
    ('Zaawansowane Techniki Marketingowe', 899.99, 30, '2025-04-05', FALSE, NULL, FALSE, '<p>Ten kurs pomoże Ci opanować zaawansowane techniki marketingowe, które zwiększą skuteczność Twoich kampanii. Nauczysz się strategii SEO, marketingu w mediach społecznościowych, e-mail marketingu i analizy danych.</p><p>Kurs zawiera również praktyczne warsztaty, podczas których stworzysz własne kampanie marketingowe i nauczysz się je optymalizować. Idealny wybór dla osób chcących rozwijać swoją karierę w branży marketingowej.</p>'),
    ('Podstawy Projektowania Graficznego', 649.50, 18, '2025-03-22', TRUE, NULL, FALSE, '<p>Poznaj podstawy projektowania graficznego i naucz się tworzyć estetyczne projekty wizualne. Kurs obejmuje pracę z kolorami, typografią, układami i podstawowe narzędzia, takie jak Adobe Photoshop i Illustrator.</p><p>Praktyczne zadania pomogą Ci zbudować portfolio i nabrać pewności w pracy z projektami graficznymi. Kurs jest idealny dla początkujących, którzy chcą rozwijać swoje umiejętności kreatywne.</p>'),
    ('Warsztaty z Kreatywnego Pisania', 399.00, 20, '2025-01-30', FALSE, NULL, TRUE, '<p>Uwolnij swoją kreatywność podczas tych warsztatów pisarskich. Nauczysz się tworzyć wciągające historie, budować interesujące postaci oraz pisać dialogi, które ożywią Twoje teksty.</p><p>Zajęcia obejmują również wskazówki dotyczące redakcji i publikacji. To doskonała okazja, aby rozwijać swoje umiejętności literackie i dzielić się swoją pasją do pisania z innymi uczestnikami.</p>'),
    ('Kurs Języka Niemieckiego dla Początkujących', 499.99, 25, '2025-02-28', TRUE, NULL, FALSE, '<p>Rozpocznij swoją przygodę z językiem niemieckim dzięki temu kursowi dla początkujących. Nauczysz się podstaw gramatyki, przydatnych wyrażeń i słownictwa, które pozwolą Ci porozumiewać się w codziennych sytuacjach.</p><p>Interaktywne lekcje pomogą Ci opanować język w praktyce, a regularne ćwiczenia sprawią, że szybko zauważysz postępy. Kurs jest doskonałym wstępem do dalszej nauki języka niemieckiego.</p>');
...
VALUES
    ...
    (10003, 1, '2025-04-22', true, 'NONE', '2024-12-04', null, null, null),
...
VALUES (10000, 'SATURDAY', '08:00:00', '20:00:00'),
